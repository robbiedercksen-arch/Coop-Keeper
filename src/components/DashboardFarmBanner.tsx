...
export default function DashboardFarmBanner() {
  ...
  return (
    <div
      className="
        relative w-full max-w-full overflow-hidden rounded-[28px] mb-6 min-h-[210px]
    ...
    >
      ...
      <div className="relative z-10 flex flex-col md:flex-row md:justify-between md:items-start gap-5 p-5 sm:p-6 md:p-8">
        <div className="pt-1 min-w-0">
          <div className="text-xs sm:text-sm tracking-[0.25em] sm:tracking-[0.32em] font-extrabold text-[#ffe8a3] mb-3 sm:mb-4">
            {greeting}
          </div>
        ...
        <div
          className="
            w-full md:w-[255px] max-w-full rounded-2xl

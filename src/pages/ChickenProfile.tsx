...
export default function ChickenProfile({
  ...
  return (
    <div style={{ padding: 20, maxWidth: 1100 }}>
      ...
      {viewNote && (
        <div style={{
          ...
          <div style={{
            ...
            <button onClick={()=>{setViewNote(null);setEditingNoteId(null);}}
              style={{
                position:"absolute",
                top:10,right:10,
            ...
            {editingNoteId===viewNote.id ? (
              <>
                ...
                <button style={{...btn,background:"#22c55e",color:"#fff",width:"100%"}} onClick={saveNote}>
                  Save Note
                </button>
              </>
            ) : (
              <>
                ...
                <small>{viewNote.date}</small>

                <div style={{display:"flex",gap:10,marginTop:12}}>
                  <button style={{...btn,background:"#f59e0b",color:"#fff",flex:1}}
                    onClick={()=>{setNoteForm(viewNote);setEditingNoteId(viewNote.id);}}
                  >Edit</button>

                  <button style={{...btn,background:"#ef4444",color:"#fff",flex:1}}
                    onClick={()=>{
                      updateChicken({
                        ...chicken,
      ...
      {/* (REST OF YOUR FILE REMAINS EXACTLY THE SAME BELOW) */}

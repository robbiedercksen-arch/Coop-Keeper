      ...
      {chickens.length === 0 ? (
        ...
        <div className="grid gap-4">
          {chickens.map((chicken) => (
            <div
              key={chicken.id}
              onClick={() => openProfile(chicken)}
              className="bg-white rounded-xl shadow-md p-4 border-l-4 border-farm-green flex justify-between items-center cursor-pointer hover:scale-[1.01] transition"
            >
              <div>
